...
describe("canonicalizeHandCashPaymentRequestUrl", () => {
    ...
    it("maps referenceId to sid", () => {
        const id = "69f93c0a0c409ffebbc08296";
        const out = canonicalizeHandCashPaymentRequestUrl(`https://pay.handcash.io/${id}?referenceId=MyRef`);
        assert.ok(out.includes("sid=MyRef"));
    });
    it("copies domain when present", () => {
        const id = "69f93c0a0c409ffebbc08296";
        const out = canonicalizeHandCashPaymentRequestUrl(`https://pay.handcash.io/${id}?domain=app.example.com`);
...
//# sourceMappingURL=payment-request-url.test.js.map