import { createHostedPayArtifact, type CreateHostedPayOptions } from "../adapters/hosted-pay.js";
 ...
 */
export async function issuePaymentRequiredWithHostedPay(
  input: IssuePaymentRequiredWithHostedPayInput,
): Promise<{ response: Response; challengeId: string } | { response: Response; error: string }> {
